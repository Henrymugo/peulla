...
const Step1StoreUrlInput: React.FC<Props> = ({ onSubmit }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!validationResult.valid) {
      setValidationError(validationResult.error || 'Please enter a valid store URL.');
      return;
    }
  ...
  return (
    <div className="p-8 md:p-16">
      <h2 className="text-3xl font-serif font-bold text-center text-text-primary mb-2">Let's Get Started</h2>
      <p className="text-center text-text-secondary mb-8">Enter your Shopify store URL to begin the brand analysis.</p>
...
export default Step1StoreUrlInput;